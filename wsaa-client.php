...
//CREANDO OBJETO AUTENTICATION COMO OBJECT (siguiendo formato del WSDL)
//$params = array();
//$params['codAduana'] = '704';
//$params['firmaWSAA'] = $firma;
//$params['idUsuario'] = 'wsaatemst';
//$params['ticketWSAA'] = $token;
//$autentication = (object) $params;

//CREANDO OBJETO AUTENTICATION CON STDCLASS
//$autentication = new stdClass();
//$autentication->idUsuario = 'wsaatemst';
//$autentication->codAduana = '704';
//$autentication->firmaWSAA = $firma;
//$autentication->ticketWSAA = $token;


//CREANDO OBJETO AUTENTICATION CON OBJECT
